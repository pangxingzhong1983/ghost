...
# Ghost is under the BSD 3-Clause license. see the LICENSE file at the root of
...
from ghost.network.lib import GhostTCPServer, GhostSocketStream
from ghost.network.lib import DummyGhostTransport, GhostSSLClient
from ghost.network.lib.rpc.utils.server import AuthenticationError
from ghost.network.transports import Transport


class GhostSSLAuthenticator(object):
...
def ssl_authenticator():
    ...
    try:
        ...
        keystr = ghost_credentials.SSL_BIND_KEY
        certstr = ghost_credentials.SSL_BIND_CERT
        castr = ghost_credentials.SSL_CA_CERT
        role = 'CLIENT'
