...
from ghost.network.lib import GhostTCPServer, GhostSSLClient, GhostSocketStream
from ghost.network.lib import RSA_AESClient, RSA_AESServer, GhostWebSocketClient, GhostWebSocketServer
...
class TransportConf(Transport):
    ...
    def __init__(self, *args, **kwargs):
        ...
        try:
            ...
            PATH_GEN_SECRET = ghost_credentials['PATH_GEN_SECRET']
