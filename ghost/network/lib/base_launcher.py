...
"""
launchers bring an abstraction layer over transports to allow ghost payloads to try multiple transports until one succeed or perform custom actions on their own.
"""
