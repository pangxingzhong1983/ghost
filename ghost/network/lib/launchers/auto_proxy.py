...
from ghost.network.lib.utils import (
    parse_transports_args,
    create_client_transport_info_for_addr,
    parse_host
)

from ghost.network.lib.base_launcher import (
    BaseLauncher, LauncherArgumentParser, LauncherError
)

from ghost.network.lib.proxies import (
    find_proxies_for_transport, connect_client_with_proxy_info
)

from ghost.network.lib.socks import ProxyError
from ghost.network.lib.netcreds import add_cred
...
class AutoProxyLauncher(BaseLauncher):
    ...
    def init_argparse(cls):
        ...
        cls.arg_parser.add_argument(
            ...
            help='host:port of the ghost server to connect to. You can provide multiple '
        ...
        cls.arg_parser.add_argument(
            ...
            help='Add proxy to chain of proxies to communicate with ghost server: '
            'TYPE:host:port (SOCKS5:192.168.0.1:1080)')
        cls.arg_parser.add_argument(
