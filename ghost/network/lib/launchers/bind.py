...
from ghost.network.lib import utils
...
class BindLauncher(BaseLauncher):
    ...
    def init_argparse(cls):
        ...
        cls.arg_parser.add_argument('-t', '--transport', choices=transports, default="ssl", help="the transport to use ! (the ghostsh.sh --connect will need to be configured with the same transport) ")
