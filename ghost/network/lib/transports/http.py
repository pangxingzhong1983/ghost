...
""" This module contains an implementation of the 'http' transport for ghost. """
...
class GhostHTTPTransport(BaseGhostTransport):
    """
...
class GhostHTTPClient(GhostHTTPTransport):
    client = True
    method = b'GET'
    keep_alive = True
    path = b'/index.php?d='
    ...
    def __init__(self, *args, **kwargs):
        GhostHTTPTransport.__init__(self, *args, **kwargs)
        self.headers = {
...
class GhostHTTPServer(GhostHTTPTransport):
    client = False
