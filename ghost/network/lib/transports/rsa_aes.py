...
""" This module contains an implementation of a simple xor transport for ghost. """

from ..base import BaseGhostTransport, TransportError
...
class RSA_AESTransport(BaseGhostTransport):
    """
