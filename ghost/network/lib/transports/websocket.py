...
""" This module contains an implementation of the 'websocket' transport for ghost.
...
__all__ = (
    'InvalidHTTPReq', 'GhostWebSocketTransport',
...
from ghost.network.lib.transports.cryptoutils import XOR
...
class GhostWebSocketTransport(BaseGhostTransport):
    """
    Implements the http protocol transport for ghost.
    """
    __slots__ = ()


class GhostWebSocketClient(GhostWebSocketTransport):
    ...
    def __init__(self, *args, **kwargs):
        GhostWebSocketTransport.__init__(self, *args, **kwargs)
...
class GhostWebSocketServer(GhostWebSocketTransport):
    __slots__ = (
