...
def _does_dest_allows_executable_mappings(folder):
    try:
        ...
        ghost.dprint('Folder {} is not accessible: {}', folder, e)
        return False
    ...
    try:
        ...
        mapping.close()
        ghost.dprint('Folder {} does allows executables', folder)
        return True

    except IOError as e:
        ghost.dprint('Exception during mmap {}', e)
        return False

    except OSError as e:
        ghost.dprint('Folder {} does not allow executables: {}', folder, e)
        return False
