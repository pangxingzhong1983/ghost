...
from ghost.ghostlib.PythonCompleter import PythonCompleter
from ghost.ghostlib.GhostOutput import Error

usage = 'Start the local python interpreter (for debugging purposes)'
parser = GhostArgumentParser(prog='python', description=usage)
