...
from ghost.ghostlib.GhostModule import GhostArgumentParser, GhostModuleUsageError
from ghost.ghostlib.GhostCompleter import (
    module_name_completer, module_args_completer, path_completer
)

from ghost.ghostlib.GhostOutput import Error, Line, Color
from ghost.ghostlib.GhostJob import GhostJob
...
parser = GhostArgumentParser(prog='run', description=usage)
