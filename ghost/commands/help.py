...
from ghost.ghostlib.GhostOutput import MultiPart, Table, Color, Line, TruncateToTerm
from ghost.ghostlib.GhostCompleter import commands_completer

usage  = 'Show help'
parser = GhostArgumentParser(prog='help', description=usage)
    ...
    if args.module:
        if handler.commands.has(args.module):
            ...
            if hasattr(command.parser, 'add_help'):
                ...
                parser = command.parser(server, GhostArgumentParser, config)
