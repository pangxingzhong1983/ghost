...
from ghost.ghostlib.GhostOutput import Success, Error, Table, Color

import time

usage = 'DNSCNC control'
parser = GhostArgumentParser(prog='dnscnc', description=usage)
