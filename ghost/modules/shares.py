...
class Shares(GhostModule):
    ...
    dependencies = {
        ...
        'all': [
            'impacket', 'calendar', 'ghostutils.share_enum'
        ]
    }
    ...
    def init_argparse(cls):
        ...
        cls.arg_parser = GhostArgumentParser(prog="shares", description=cls.__doc__, epilog=example)
    ...
    def run(self, args):
        ...
        connect = self.client.remote('ghostutils.share_enum', 'connect')
