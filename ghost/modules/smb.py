    ...
    def cache(self, args):
        if args.command in ('enable', 'disable'):
            set_use_cache = self.client.remote(
                'ghostutils.psexec', 'set_use_cache', False
            )
            ...
            get_cache = self.client.remote(
                'ghostutils.psexec', 'get_cache', False
            )
            ...
            clear_session_caches = self.client.remote(
                'ghostutils.psexec', 'clear_session_caches', False
            )
            clear_session_caches()

    def get_ft(self, args, host):
        create_filetransfer = self.client.remote(
            'ghostutils.psexec', 'create_filetransfer', False)
