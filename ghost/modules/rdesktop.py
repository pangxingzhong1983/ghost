...
from ghost.ghostlib.GhostModule import GhostModule, config, GhostArgumentParser
from ghost.ghostlib.GhostWeb import RequestHandler, WebSocketHandler, tornado
...
class RemoteDesktopModule(GhostModule):
    ...
    def init_argparse(cls):
        cls.arg_parser = GhostArgumentParser(prog="rdesktop", description=cls.__doc__)
    ...
    def run(self, args):
        ...
        if not conninfo:
            ...
            self.info('Enable with "config set ghostd webserver true"')
            return
