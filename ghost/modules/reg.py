...
class reg(GhostModule):
    ...
    dependencies = {
        'windows': ['reg'],
        'all': ['ghostutils.psexec', 'ghostutils.rreg']
    }

    @classmethod
    def init_argparse(cls):
        cls.arg_parser = GhostArgumentParser(prog='reg', description=cls.__doc__)
    ...
    def _method(self, name, args, serialize=True):
        if args.host:
            method = self.client.remote('ghostutils.rreg', name, serialize)
