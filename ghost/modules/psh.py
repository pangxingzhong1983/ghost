...
from ghost.network.lib.rpc import GenericException
...
class PowershellManager(GhostModule):
    ...
    def init_argparse(cls):
        ...
        load.add_argument('source', nargs='?', help='Path to PS1 script (local to ghost)')
