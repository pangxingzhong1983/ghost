...
from ghost.modules.lib.utils.shell_exec import shell_exec
...
# CredDump imports
from ghost.modules.lib.windows.creddump.win32.domcachedump import dump_hashes
from ghost.modules.lib.windows.creddump.addrspace import HiveFileAddressSpace
from ghost.modules.lib.windows.creddump.win32.hashdump import get_bootkey, get_hbootkey
from ghost.modules.lib.windows.creddump.win32.hashdump import get_user_hashes, get_user_keys, get_user_name
from ghost.modules.lib.windows.creddump.win32.hashdump import empty_lm, empty_nt
from ghost.modules.lib.windows.creddump.win32.lsasecrets import get_file_secrets
...
class CredDump(GhostModule):
    """ download the hives from a remote windows system and dump creds """

    @classmethod
    def init_argparse(cls):
        cls.arg_parser = GhostArgumentParser(prog='hive', description=cls.__doc__)
