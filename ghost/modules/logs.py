...
from ghost.ghostlib.GhostOutput import TruncateToTerm, List, Color, Line

from datetime import datetime

__class_name__='Logs'
@config(cat='admin', compat=['posix', 'windows'])
class Logs(GhostModule):
    ...
    def init_argparse(cls):
        cls.arg_parser = GhostArgumentParser(prog='logs', description=cls.__doc__)
