...
Demo: https://vimeo.com/157356150"""
    ...
    def init_argparse(cls):
        cls.arg_parser = GhostArgumentParser(prog="Linux Stealth Module", description=cls.__doc__)
        cls.arg_parser.add_argument('--port', default=None, help='The port number to which Ghost is connecting to.')
