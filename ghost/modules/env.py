...
from ghost.ghostlib.GhostOutput import Table, TruncateToTerm

from ghost.network.lib.convcompat import as_escaped_string


__class_name__='Env'
@config(cat='manage')
class Env(GhostModule):
    ...
    def run(self, args):
        environ = self.client.remote('ghostutils.basic_cmds', 'env')
