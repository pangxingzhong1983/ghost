...
from ghost.modules.lib.windows.winpcap import init_winpcap
from ghost.ghostlib.utils.rpyc_utils import redirected_stdo
from ghost.ghostlib.GhostModule import (
    config, GhostModule, GhostArgumentParser, QA_DANGEROUS
)
...
@config(cat="admin")
class InteractiveScapyShell(GhostModule):
    ...
    def init_argparse(cls):
        cls.arg_parser = GhostArgumentParser(prog='scapy', description=cls.__doc__)
