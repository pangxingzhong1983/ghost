...
from ghost.ghostlib.GhostOutput import Color, Line, Table

from ghost.network.lib.compat import as_native_string
...
class IPModule(GhostModule):
    ...
    def run(self, args):
        try:
            interfaces = self.client.remote('ghostps', 'interfaces')
            families = {
