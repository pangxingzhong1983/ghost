...
from ghost.ghostlib.GhostOutput import Table, List, NewLine
from ghost.ghostlib.GhostModule import (
    config, GhostModule, GhostArgumentParser, GhostConfig
)
...
class ODBC(GhostModule):
    ...
    def query(self, args):
        ...
        if args.dump:
            config = self.client.pupsrv.config or GhostConfig()
