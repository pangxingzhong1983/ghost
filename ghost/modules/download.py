...
from ghost.ghostlib.GhostCompleter import remote_path_completer, path_completer

from ghost.modules.lib.utils.download import DownloadFronted
...
class DownloaderScript(GhostModule):
    ...
    def init_argparse(cls):
        cls.arg_parser = GhostArgumentParser(prog='download', description=cls.__doc__)
