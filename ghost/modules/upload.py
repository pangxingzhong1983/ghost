...
from ghost.ghostlib.GhostCompleter import path_completer, remote_dirs_completer
...
@config(cat="manage")
class UploaderScript(GhostModule):
    """ upload a file/directory to a remote system """

    @classmethod
    def init_argparse(cls):
        cls.arg_parser = GhostArgumentParser(prog='upload', description=cls.__doc__)
