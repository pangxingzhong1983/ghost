...
class TcpdumpModule(GhostModule):
    ...
    def init_argparse(cls):
        ...
        cls.arg_parser = GhostArgumentParser(prog='tcpdump.py', description=cls.__doc__, epilog=example)
        ...
        # yup mandatory cause you have to put ghost's IP/PORT anyway
        cls.arg_parser.add_argument("--bpf", required=True, help="use a BPF (Warning: It is highly advised to whitelist"
                                                                 " ghost's shell IP/PORT you are currently using to "
