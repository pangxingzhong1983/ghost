...
from ghost.ghostlib.GhostOutput import Table, List
...
class RWMIC(GhostModule):
    ...
    def init_argparse(cls):
        cls.arg_parser = GhostArgumentParser(prog="rwmic", description=cls.__doc__)
    ...
    def run(self, args):
        wql = self.client.remote('ghostutils.psexec', 'wql')
        if args.query:
