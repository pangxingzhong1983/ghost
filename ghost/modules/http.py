...
from ghost.ghostlib.GhostOutput import Pygment, Table, NewLine
...
class http(GhostModule):
    ...
    def init_argparse(cls):
        cls.arg_parser = GhostArgumentParser(prog='http', description=cls.__doc__)
