...
class Pywerview(GhostModule):
    ...
    def init_argparse(cls):
        ...
        #      - argparse.ArgumentParser to GhostArgumentParser
        #      - parser to cls.arg_parser
        #      - function name to string (ex: func=get_adobject to func="get_adobject")

        cls.arg_parser = GhostArgumentParser(description='Rewriting of some PowerView\'s functionalities in Python')
        ...
        # Credentials parser
        credentials_parser = GhostArgumentParser(add_help=False)
        ...
        ad_parser = GhostArgumentParser(add_help=False, parents=[credentials_parser])
        ...
        target_parser = GhostArgumentParser(add_help=False, parents=[credentials_parser])
