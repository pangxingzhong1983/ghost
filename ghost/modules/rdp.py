...
class Rdp(GhostModule):
    ...
    def init_argparse(cls):
        ...
        cls.arg_parser = GhostArgumentParser(prog="Rdp", description=cls.__doc__, epilog=example)
    ...
    def run(self, args):
        ...
        if args.local:
            ...
            check_rdp = self.client.remote('ghostutils.rdp_check', 'check_rdp', False)
