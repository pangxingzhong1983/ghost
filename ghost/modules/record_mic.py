...
class RecordMicrophoneModule(GhostModule):
    ...
    def init_argparse(cls):
        cls.arg_parser = GhostArgumentParser(prog='record_mic', description=cls.__doc__)
    ...
    def run(self, args):
        ...
        if int(max_length) > int(args.time):
            raise GhostModuleError("--max-length argument cannot be bigger than --time")
