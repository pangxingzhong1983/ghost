...
from ghost.ghostlib.GhostOutput import Color, TruncateToTerm, Table
...
class Services(GhostModule):
    ...
    def init_argparse(cls):
        cls.arg_parser = GhostArgumentParser(prog="services", description=cls.__doc__)
    ...
    def run(self, args):
        ...
        if self.client.is_linux():
            ...
            get_services = self.client.remote('ghostps', 'get_win_services')
        else:
