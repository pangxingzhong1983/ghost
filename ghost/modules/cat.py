...
from ghost.ghostlib.GhostOutput import Pygment, Hex
from ghost.ghostlib.GhostCompleter import remote_path_completer
from pygments.lexers import guess_lexer, guess_lexer_for_filename
from ghost.network.lib.convcompat import is_binary, DEFAULT_MB_ENCODING
...
class cat(GhostModule):
    ...
    def run(self, args):
        try:
            cat = self.client.remote('ghostutils.basic_cmds', 'cat', False)
