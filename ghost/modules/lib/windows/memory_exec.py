...
from ghost.ghostlib.utils.pe import get_pe_arch, is_dotnet_bin
from ghost.modules.lib.utils.cmdrepl import CmdRepl
...
def exec_pe(
    ...
    if path:
        ...
        if pe_arch != proc_arch:
            module.error(
                '%s is a %s PE and your ghost payload is a %s process. '
