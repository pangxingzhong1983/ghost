...
from ghost.ghostlib.GhostModule import config, GhostModule, GhostArgumentParser, REQUIRE_STREAM
...
class SSH(GhostModule):
    ...
    def init_argparse(cls):
        cls.arg_parser = GhostArgumentParser(prog='ssh', description=cls.__doc__)
