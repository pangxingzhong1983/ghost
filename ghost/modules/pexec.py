...
class PExec(GhostModule):
    ...
    dependencies = ["ghostutils.safepopen"]
    io = REQUIRE_STREAM

    @classmethod
    def init_argparse(cls):
        cls.arg_parser = GhostArgumentParser(prog='pexec', description=cls.__doc__)
    ...
    def run(self, args):
        ...
        safe_exec = self.client.remote('ghostutils.safepopen', 'safe_exec', False)
        cmdenv = {
