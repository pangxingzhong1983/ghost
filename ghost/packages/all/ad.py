...
from ghost.network.lib.dnsinfo import dnsinfo
from ghost.network.lib.scan import scan

try:
    import ghost.agent
    from ghost.network.lib.netcreds import find_creds

    logger = ghost.get_logger('ad')
except ImportError:
    import logging
